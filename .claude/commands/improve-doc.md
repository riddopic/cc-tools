...
```
/improve-doc docs/guides/getting-started.md
```
...
Load `docs-style` for core writing principles that apply to all documentation types.
...
- Tutorial sections: `tutorial-docs`
- How-To sections: `howto-docs`
- Reference sections: `reference-docs`
- Explanation sections: `explanation-docs`
