...
allowed-tools:
  ...
  - Bash
  - Write
argument-hint: "[--domain <name>] [--threshold <n>] [--generate]"
skills:
...
- `--generate` - Actually create the evolved structures (default is preview)
...
---
Run `/evolve --generate` to create these files.
```
