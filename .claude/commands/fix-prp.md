---
description: Fix PRP Implementation Issues
allowed-tools:
  - Read
  - Grep
  - Glob
...
- Original PRP: `docs/PRPs/$ARGUMENTS.md`
- Evaluation Report: `docs/PRPs/$ARGUMENTS-evaluation.md`
- Fixes Document: `docs/PRPs/$ARGUMENTS-fixes.md`
...
/evaluate-prp agent-implementation
# Creates: docs/PRPs/agent-implementation-evaluation.md (score: 7/10)
# Creates: docs/PRPs/agent-implementation-fixes.md

# Fix the issues
/fix-prp agent-implementation
# Reads all three files and systematically fixes issues
