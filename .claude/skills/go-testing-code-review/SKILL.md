...
|------------|-----------|
| Test structure, naming | `docs/examples/patterns/testing.md` |
| Mocking, interfaces | `docs/examples/patterns/mocking.md` |
| Testing standards | `docs/CODING_GUIDELINES.md` §8 |
...
- Reviewing test file structure → `docs/examples/patterns/testing.md`
- Reviewing mock implementations → `docs/examples/patterns/mocking.md`
- Testing standards and conventions → `docs/CODING_GUIDELINES.md` §8
