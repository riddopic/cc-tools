...
For Go packages, follow godoc conventions from [documentation.md](../../../docs/examples/standards/documentation.md):

```go
// Package analyzer provides vulnerability detection for smart contracts.
// It supports multiple analysis strategies and outputs structured results.
package analyzer

// Analyzer detects vulnerabilities in smart contract bytecode.
// It uses configurable detection strategies and maintains analysis history.
type Analyzer struct {
    // strategies holds the registered detection strategies.
    strategies []Strategy
}
...
For reference docs not auto-generated (configuration, APIs), place in:
- `docs-site/content/en/docs/user-guide/` for user-facing reference
- Inline godoc comments for developer-facing reference

### Project References

- [CODING_GUIDELINES.md](../../../docs/CODING_GUIDELINES.md) - Go coding standards
- [docs/examples/standards/documentation.md](../../../docs/examples/standards/documentation.md) - Godoc patterns
