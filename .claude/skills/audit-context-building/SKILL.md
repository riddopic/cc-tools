...
## 3.1 Rationalizations (Do Not Skip)
...
For codebases with many files, apply `recursive-decomposition` strategies to partition the analysis across sub-agents rather than loading everything into a single context.
