...
|------------|-----------|
| Missing error checks, wrapped errors | `docs/CODING_GUIDELINES.md` §5, `docs/examples/standards/go-specific.md` |
| Race conditions, channel misuse | `docs/examples/patterns/concurrency.md` |
| Interface pollution, naming | `docs/examples/standards/interfaces.md` |
...
- Reviewing error return patterns → `docs/CODING_GUIDELINES.md` §5, `docs/examples/standards/go-specific.md`
- Reviewing goroutines/channels → `docs/examples/patterns/concurrency.md`
- Reviewing type definitions → `docs/examples/standards/interfaces.md`
- General Go review → `references/common-mistakes.md`
