...
```
docs-site/content/en/docs/
├── cli/           # Auto-generated CLI reference (don't edit manually)
├── user-guide/    # Manual user guides and tutorials
...
For Go package documentation, follow patterns in [documentation.md](../../../docs/examples/standards/documentation.md):
...
- [CODING_GUIDELINES.md](../../../docs/CODING_GUIDELINES.md) - Project coding standards
- [docs/examples/](../../../docs/examples/) - Documentation examples and templates
