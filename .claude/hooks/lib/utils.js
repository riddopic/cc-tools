...
/**
 * Get the project-local Claude config directory
 */
...
/**
 * Get the learned skills directory (project-relative)
 */
function getLearnedSkillsDir() {
  // Use project's .claude directory, not home directory
  return path.join(process.cwd(), '.claude', 'skills', 'learned');
}
