...
// The short-id is optional (old format) and can be 1+ alphanumeric characters
// Matches: "2026-02-01-session.tmp" or "2026-02-01-quanta-session.tmp"
const SESSION_FILENAME_REGEX = /^(\d{4}-\d{2}-\d{2})(?:-([a-z0-9]+))?-session\.tmp$/;
